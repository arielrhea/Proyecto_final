...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-07-2024 a las 18:11:26
...
--
CREATE DATABASE IF NOT EXISTS `prueba_chat_swaply` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `prueba_chat_swaply`;
...
ALTER TABLE `chats`
  ...
  ADD CONSTRAINT `chats_ibfk_3` FOREIGN KEY (`ProductoID`) REFERENCES `productos` (`ID`);
...
--
ALTER TABLE `mensajes`
  ADD CONSTRAINT `mensajes_ibfk_1` FOREIGN KEY (`ChatID`) REFERENCES `chats` (`ID`) ON UPDATE NO ACTION,
  ADD CONSTRAINT `mensajes_ibfk_2` FOREIGN KEY (`UsuarioID`) REFERENCES `usuarios` (`ID`);
