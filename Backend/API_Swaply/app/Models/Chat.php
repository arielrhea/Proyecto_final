...
class Chat extends Model
{
    ...
    public static function consulta($id) {
        return Chat::with(['producto:ID,Titulo,Imagenes,ProductoReservado','usuario1:ID,NombreUsuario,FotoPerfil', 'usuario2:ID,NombreUsuario,FotoPerfil', 'mensaje' => function ($query) {
